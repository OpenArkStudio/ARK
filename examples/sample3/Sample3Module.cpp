...
void Sample3Module::QueryStringTest(const guid_t& guid, size_t count, const uint32_t index)
{
...
void Sample3Module::QueryIntTest(const guid_t& guid, size_t count, const uint32_t index)
{
    auto pEntity = m_pKernelModule->GetEntity(guid);
    if (nullptr == pEntity)
    {
...
void Sample3Module::SetDataTest(const guid_t& guid, size_t count, const uint32_t index)
{
    auto pEntity = m_pKernelModule->GetEntity(guid);
    if (nullptr == pEntity)
    {
...
void Sample3Module::CustomDataTest(const guid_t& guid, size_t count, const uint32_t index)
{
...
int Sample3Module::OnClassCallBackEvent(
    const guid_t& self, const std::string& strClassName, const ArkEntityEvent event, const AFIDataList& arg)
{
...
int Sample3Module::OnDataCallBackEvent(const guid_t& self, const std::string& data_name, const uint32_t index,
...
int Sample3Module::OnTableCallBackEvent(
    const guid_t& self, const TABLE_EVENT_DATA& data, const AFIData& old_value, const AFIData& new_value)
{
...
int Sample3Module::OnContainerCallBackEvent(const guid_t& self, const uint32_t index, const ArkContainerOpType op_type,
