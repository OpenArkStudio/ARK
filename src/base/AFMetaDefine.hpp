...
public:
    ...
    static const std::string &cur_attr()
    {
        static const std::string cur_attr_ = "cur_attr";
        return cur_attr_;
    } // sub_struct - AFEntityMetaCurrentAttr
    static const std::string &items()
    {
        static const std::string items_ = "items";
        return items_;
    } // data_table - AFEntityMetaItemBag
    static const std::string &equips()
    {
        static const std::string equips_ = "equips";
        return equips_;
    } // data_table - AFEntityMetaEquipBag
};
