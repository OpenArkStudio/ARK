...
public:
    ...
    void swap(AFTimespan& timespan) noexcept
    {
...
public:
    ...
    void swap(AFDateTime& timestamp) noexcept
    {
...
inline void swap(AFDateTime& d1, AFDateTime& d2) noexcept
{
    d1.swap(d2);
}
