...
{
public:
    virtual bool SendSuitSSMsg(const uint8_t app_type, const std::string &hash_key, const int msg_id, const google::protobuf::Message &msg,
        const AFGUID &actor_id = 0) = 0;
    virtual bool SendSuitSSMsg(const uint8_t app_type, const uint32_t &hash_value, const int msg_id, const google::protobuf::Message &msg,
        const AFGUID &actor_id = 0) = 0;
    virtual bool SendParticularSSMsg(
        const int bus_id, const int msg_id, const google::protobuf::Message &msg, const AFGUID &conn_id, const AFGUID &actor_id = 0) = 0;

    virtual bool SendSSMsg(const int src_bus, const int target_bus, const int msg_id, const char *msg, const int msg_len,
        const AFGUID &conn_id, const AFGUID &actor_id = 0) = 0;
    virtual bool SendSSMsg(const int target_bus, const int msg_id, const google::protobuf::Message &msg, const AFGUID &conn_id,
        const AFGUID &actor_id = 0) = 0;
    virtual bool SendSSMsg(
        const int target_bus, const int msg_id, const char *msg, const int msg_len, const AFGUID &conn_id, const AFGUID &actor_id = 0) = 0;
    ...
    static bool TableListToPB(
        AFGUID self, ARK_SHARE_PTR<AFIDataTableManager> &pTableManager, AFMsg::EntityDataTableList &xPBData, const AFFeatureType nFeature)
    {
    ...
    static bool NodeListToPB(
        AFGUID self, ARK_SHARE_PTR<AFIDataNodeManager> pNodeManager, AFMsg::EntityDataNodeList &xPBData, const AFFeatureType nFeature)
    {
...
#define ARK_PROCESS_ACTOR_MSG(head, msg_id, msg, msg_len, pb_msg)                                                                          \
    ...
    {                                                                                                                                      \
        ...
        return;                                                                                                                            \
                                                                                                                                           ...
                                                                                                                                           \
    ARK_LOG_DEBUG("Recv msg log src={} dst={} msg_name={} msg_id={} msg_len={}\nmsg_data={}", "", "", x_msg.GetTypeName(), msg_id,         \
        msg_len, x_msg.DebugString());                                                                                                     \
                                                                                                                                           \
...
#define ARK_PROCESS_MSG(msg, pb_msg_type)                                                                                                  \
    ...
    {                                                                                                                                      \
        ...
        ARK_LOG_DEBUG("Recv msg log src={} dst={} msg_name={} msg_id={} nmsg_len={}\nmsg_data={}", msg->src_bus_, msg->dst_bus_,           \
            pb_msg.GetTypeName(), msg->id_, msg->length_, pb_json);                                                                        \
    }
