...
{
public:
    AFIDataNewType& operator=(const AFIDataNewType& rhs) = delete;
    ...
    bool equal(const AFIDataNewType& src)
    {
    ...
    virtual void Assign(const AFIDataNewType& src) = 0;
    virtual size_t GetMemUsage() const = 0;
    virtual std::string ToString() = 0;
    virtual ~AFIDataNewType() = default;
};
