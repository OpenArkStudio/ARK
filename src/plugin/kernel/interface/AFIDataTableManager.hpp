...
public:
    ...
    bool RegisterCallback(BaseType* pBase,
    ...
    virtual bool AddTable(const AFGUID& self_id, const char* table_name, const AFIDataList& col_type_list,
        const AFFeatureType feature) = 0;
