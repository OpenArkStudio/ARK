...
void AFCProxyNetModule::OnServerInfoProcess(const AFNetMsg* msg, conv_id_t session_id) {}

void AFCProxyNetModule::OnSelectServerResultProcess(const AFNetMsg* msg, conv_id_t session_id) {}
...
void AFCProxyNetModule::OnClientConnected(const guid_t& conn_id)
{
...
void AFCProxyNetModule::OnClientDisconnect(const guid_t& conn_id)
{
    // do something
}

bool AFCProxyNetModule::CheckSessionState(const int nGameID, const guid_t& xClientID, const std::string& strAccount)
{
...
void AFCProxyNetModule::OnOtherMessage(const AFNetMsg* msg, conv_id_t session_id)
{
    // Transpond(xHead, nMsgID  msg, nLen);
}

void AFCProxyNetModule::OnBrocastmsg(const AFNetMsg* msg, conv_id_t session_id)
{
