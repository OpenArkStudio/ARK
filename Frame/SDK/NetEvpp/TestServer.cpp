...
public:
    ...
    void ReciveHandler(const int nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen, const AFGUID& xClientID)
    {
        std::string str;
        str.assign(msg, nLen);
    ...
    void EventHandler(const int nSockIndex, const NF_NET_EVENT e, const AFGUID& xClientID, const int nServerID)
    {
