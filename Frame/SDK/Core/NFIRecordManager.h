...
public:
    ...
    /**
     * @fn  virtual NF_SHARE_PTR<NFIRecord> NFIRecordManager::AddRecord(const AFGUID& self, const std::string& strRecordName, const NF_SHARE_PTR<AFDataList>& TData, const NF_SHARE_PTR<AFDataList>& tagData, const int nRows) = 0;
     *
     * @brief   Adds a record.
     *
     * @author  flyicegood
    ...
    /**
     * @fn  virtual const AFGUID& NFIRecordManager::Self() = 0;
     *
     * @brief   Gets the self.
     *
     * @author  flyicegood
    ...
    /**
     * @fn  virtual bool NFIRecordManager::SetRecordObject(const std::string& strRecordName, const int nRow, const int nCol, const AFGUID& obj) = 0;
     *
    ...
    virtual bool SetRecordObject(const std::string& strRecordName, const int nRow, const int nCol, const AFGUID& obj) = 0;
    ...
    /**
     * @fn  virtual bool NFIRecordManager::SetRecordObject(const std::string& strRecordName, const int nRow, const std::string& strColTag, const AFGUID& value) = 0;
     *
     * @brief   Sets record object.
     *
     * @author  flyicegood
    ...
    /**
     * @fn  virtual const AFGUID& NFIRecordManager::GetRecordObject(const std::string& strRecordName, const int nRow, const int nCol) = 0;
     *
    ...
    /**
     * @fn  virtual const AFGUID& NFIRecordManager::GetRecordObject(const std::string& strRecordName, const int nRow, const std::string& strColTag) = 0;
     *
     * @brief   Gets record object.
     *
     * @author  flyicegood
