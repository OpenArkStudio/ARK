// -------------------------------------------------------------------------
//    @FileName         :    AFIPropertyManager.h
//    @Author           :    Ark Game Tech
//    @Date             :    2012-03-01
//    @Module           :    AFIPropertyManager
//
// -------------------------------------------------------------------------
...
class AFIPropertyManager
    : public AFMapEx<std::string, AFIProperty>
{
public:
    virtual ~AFIPropertyManager() {}

    virtual bool RegisterCallback(const std::string& strProperty, const PROPERTY_EVENT_FUNCTOR_PTR& cb) = 0;

    virtual NF_SHARE_PTR<AFIProperty> AddProperty(const AFGUID& self, NF_SHARE_PTR<AFIProperty> pProperty) = 0;
    virtual NF_SHARE_PTR<AFIProperty> AddProperty(const AFGUID& self, const std::string& strPropertyName, const int varType) = 0;
