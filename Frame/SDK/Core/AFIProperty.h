...
public:
    ...
    virtual void SetValue(const AFIProperty* pProperty) = 0;

    virtual bool SetBool(const bool value) = 0;
    virtual bool SetInt(const int32_t value) = 0;
    virtual bool SetInt64(const int64_t value) = 0;
    ...
    virtual const NF_SHARE_PTR<AFMapEx<std::string, std::string>> GetEmbeddedMap() const = 0;
