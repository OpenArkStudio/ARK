...
public:
    NFCObject() = delete;
    NFCObject(const AFGUID& self, NFIPluginManager* pLuginManager);
    virtual ~NFCObject();
...
protected:
    ...
    virtual bool AddHeartBeat(const std::string& strHeartBeatName, const HEART_BEAT_FUNCTOR_PTR& cb, const NFINT64 nTime, const int nCount);
