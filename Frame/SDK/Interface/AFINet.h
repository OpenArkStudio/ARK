...
typedef std::function<void(const AFIMsgHead& xHead, const int nMsgID, const char* msg, const size_t nLen, const AFGUID& nClientID)> NET_RECV_FUNCTOR;
typedef std::shared_ptr<NET_RECV_FUNCTOR> NET_RECV_FUNCTOR_PTR;
