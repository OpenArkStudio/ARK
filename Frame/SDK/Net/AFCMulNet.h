...
public:
    ...
    AFCMulNet(BaseType* pBaseType, void (BaseType::*handleRecieve)(const int, const int, const char*, const uint32_t, const AFGUID&), void (BaseType::*handleEvent)(const int, const NF_NET_EVENT, const AFGUID&, const int))
    {
        base = NULL;
        listener = NULL;
        mpNetThread = NULL;
...
private:
    ...
    AFLockFreeQueue<SendmsgInfo> mqSendMsg;
    AFLockFreeQueue<RecivemsgInfo> mqReciveMsg;
    AFLockFreeQueue<EventInfo> mqEventInfo;
    AFLockFreeQueue<NetTaskInfo> mqNetTaskInfo;
