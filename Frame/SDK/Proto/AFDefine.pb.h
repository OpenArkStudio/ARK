...
#define PROTOBUF_AFDefine_2eproto__INCLUDED
...
void LIBPROTOC_EXPORT protobuf_AddDesc_AFDefine_2eproto();
...
template <> struct is_proto_enum< ::AFMsg::EShopType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EShopType>() {
  return ::AFMsg::EShopType_descriptor();
}
