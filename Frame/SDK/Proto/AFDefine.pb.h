...
#ifndef PROTOBUF_AFDefine_2eproto_INCLUDED
#define PROTOBUF_AFDefine_2eproto_INCLUDED
...
enum EGameMsgID {
  ...
  EGMI_ACK_PROPERTY_DATA = 210,
  EGMI_ACK_ADD_ROW = 220,
  EGMI_ACK_REMOVE_ROW = 221,
  EGMI_ACK_SWAP_ROW = 222,
  EGMI_ACK_RECORD_DATA = 223,
  EGMI_ACK_RECORD_CLEAR = 229,
  EGMI_ACK_RECORD_SORT = 230,
  EGMI_REQ_MOVE = 235,
  EGMI_ACK_MOVE = 236,
...
const EGameCardSubType EGameCardSubType_MIN = EGCST_NONE;
...
const ERankType ERankType_MIN = ERT_PLAYER_NONE;
...
const EPropertyType EPropertyType_MIN = EPT_NONE;
...
template <> struct is_proto_enum< ::AFMsg::EGameEventCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameEventCode>() {
  return ::AFMsg::EGameEventCode_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameMsgID> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameMsgID>() {
  return ::AFMsg::EGameMsgID_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EItemType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EItemType>() {
  return ::AFMsg::EItemType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameEquipSubType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameEquipSubType>() {
  return ::AFMsg::EGameEquipSubType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameGemSubType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameGemSubType>() {
  return ::AFMsg::EGameGemSubType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameItemSubType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameItemSubType>() {
  return ::AFMsg::EGameItemSubType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameCardSubType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameCardSubType>() {
  return ::AFMsg::EGameCardSubType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameTokenSubType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameTokenSubType>() {
  return ::AFMsg::EGameTokenSubType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameItemExpiredType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameItemExpiredType>() {
  return ::AFMsg::EGameItemExpiredType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EDrawDropItemState> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EDrawDropItemState>() {
  return ::AFMsg::EDrawDropItemState_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGuildPowerType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGuildPowerType>() {
  return ::AFMsg::EGuildPowerType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::ETaskState> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::ETaskState>() {
  return ::AFMsg::ETaskState_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::ETaskType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::ETaskType>() {
  return ::AFMsg::ETaskType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EBattleType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EBattleType>() {
  return ::AFMsg::EBattleType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::ERankType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::ERankType>() {
  return ::AFMsg::ERankType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::ENPCType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::ENPCType>() {
  return ::AFMsg::ENPCType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EPropertyType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EPropertyType>() {
  return ::AFMsg::EPropertyType_descriptor();
}
template <> struct is_proto_enum< ::AFMsg::EGameElementType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AFMsg::EGameElementType>() {
  return ::AFMsg::EGameElementType_descriptor();
}
...
#endif  // PROTOBUF_AFDefine_2eproto_INCLUDED
