...
#include "Server/Interface/AFIRouterNetClientModule.h"
#include "Server/Interface/AFIRouterNetServerModule.h"

namespace ark
{

    class AFCRouterNetClientModule : public AFIRouterNetClientModule
    {
    public:
        explicit AFCRouterNetClientModule() = default;
