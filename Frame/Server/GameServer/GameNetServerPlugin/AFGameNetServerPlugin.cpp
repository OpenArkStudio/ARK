...
ARK_DLL_PLUGIN_ENTRY(AFGameNetServerPlugin)
ARK_DLL_PLUGIN_EXIT(AFGameNetServerPlugin)

#endif
//////////////////////////////////////////////////////////////////////////

int AFGameNetServerPlugin::GetPluginVersion()
{
    return 0;
}
...
{
    UNREGISTER_MODULE(pPluginManager, AFIGameNetServerModule, AFCGameNetServerModule)
}
