...
#ifdef AFGAMESERVERNET_CLIENTPLUGIN_EXPORTS
#define AFGAMESERVERNET_CLIENTPLUGIN_API __declspec(dllexport)
#else
#define AFGAMESERVERNET_CLIENTPLUGIN_API __declspec(dllimport)
#endif

class AFGameNetClientPlugin : public AFIPlugin
{
public:
    AFGameNetClientPlugin(AFIPluginManager* p)
    {
        pPluginManager = p;
    }
